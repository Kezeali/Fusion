...
source/%.o: ../source/%.cpp
	...
	g++ -DTIXML_USE_TICPP -DTIXML_USE_STL -D_DEBUG -DFSN_USE_ASSERT -DFSN_PROFILING_ENABLED -DBOOST_BIND_NO_PLACEHOLDERS -I"/home/kezeali/FusionGit/Fusion/Visual/include" -I"/home/kezeali/FusionGit/Fusion/Network/include" -I"/home/kezeali/FusionGit/ScriptUtils/include" -I"/home/kezeali/FusionGit/Fusion/external" -I"/home/kezeali/FusionGit/Fusion/Common/include" -I"/home/kezeali/FusionGit/Fusion/ComponentInterface/include" -I"/home/kezeali/FusionGit/Fusion/Systems/ClanLibRendering" -I"/home/kezeali/FusionGit/Fusion/Systems/ClanLibRendering/include" -I"${RAKNET_ROOT}/include/raknet" -I"${BOOST_ROOT}/include" -O0 -g3 -c -fmessage-length=0 -std=c++0x -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
