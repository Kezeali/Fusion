...
#ifndef Header_FusionEngine_RNode
#define Header_FusionEngine_RNode
...
namespace FusionEngine
{
	 ...
	 * RNode - Resource Node
	 *
	 * A RNode (for 'Resource Node') represents a node in the Resource Tree. Each
	 * RNode contains Resources and sub RNodes. The Resource Tree could be seen as
