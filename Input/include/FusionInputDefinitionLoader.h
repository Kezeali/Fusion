/*
*  Copyright (c) 2008-2011 Fusion Project Team
*
...
#ifndef H_FusionInputDefinitionLoader
#define H_FusionInputDefinitionLoader
...
namespace FusionEngine
{
	...
	public:
		...
		const InputDefinition &GetInputDefinition(uint16_t input_index) const;
