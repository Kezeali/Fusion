...
#ifndef Header_FusionEngine_MainMenu
#define Header_FusionEngine_MainMenu
...
namespace FusionEngine
{
	...
	public:
		...
		* Constructor.
		*/
		MainMenu(FusionEngine::ClientOptions *clientopts, FusionEngine::ServerOptions *serveropts);
