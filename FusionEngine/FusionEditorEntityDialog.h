...
#ifndef Header_FusionEngine_EntityDialog
#define Header_FusionEngine_EntityDialog
...
namespace FusionEngine
{
	...
	{
	public:
		EntityEditorDialog(const GameMapLoader::GameMapEntityPtr &map_entity, UndoableActionManager *undo);
		~EntityEditorDialog();
