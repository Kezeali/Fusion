...
namespace FusionEngine { namespace Inspectors
{
	...
	{
		AddTextProperty("PolygonFile",
			[](ComponentPtr component)->std::string { return ComponentIPtr<IPolygonShape>(component)->PolygonFile.Get(); },
			[](ComponentPtr component, std::string value) { ComponentIPtr<IPolygonShape>(component)->PolygonFile.Set(value); });
