...
#ifndef H_FusionResourceDatabase
#define H_FusionResourceDatabase
...
namespace FusionEngine
{
	...
	public:
		...
		bool RemoveResourceType(const std::string& path);

		void OnResourceLoaded(const ResourceDataPtr& resource);

	private:
		std::unique_ptr<kyotocabinet::HashDB> m_Database;
